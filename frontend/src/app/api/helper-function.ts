...
export const createEvent = async (host: string,location:string, capacity:number,name:string, start_date:string, end_date:string, type:string) => {
  try {
    const newEvent = { host,location,capacity, name, start_date,end_date,type };

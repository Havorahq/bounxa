...
import { getTransactionFailedMessage, isZeroAddress, } from '../../utils/index.js';
        ...
        Object.defineProperty(this, "executeStep", {
            ...
            value: async (step) => {
                ...
                if (checkForAllowance) {
                    const data = await checkAllowance(this.client, fromChain, step, this.statusManager, this.executionOptions, this.allowUserInteraction, shouldBatchTransactions);
                    if (data) {
                ...
                if (process.status !== 'DONE') {
                    ...
                    try {
                        if (isMultisigClient && multisigProcess) {
                            ...
                            await updateMultisigRouteProcess(multisigTxHash, step, process.type, fromChain, this.statusManager, this.multisig);
                        }
                        let txHash;
                        if (process.txHash) {
                            // Make sure that the chain is still correct
                        ...
                        if (isMultisigClient && process.status === 'ACTION_REQUIRED') {
                            await updateMultisigRouteProcess(transactionReceipt?.transactionHash || txHash, step, process.type, fromChain, this.statusManager, this.multisig);
                        }
                ...
                try {
                    ...
                    this.statusManager.updateExecution(step, 'FAILED');
                    throw await parseEVMErrors(e, step, process);
                }
                // DONE
                return step;
            }

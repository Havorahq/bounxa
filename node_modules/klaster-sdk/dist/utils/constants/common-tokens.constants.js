...
import { arbitrum, avalanche, base, bsc, mainnet, optimism, polygon, scroll, } from "viem/chains";
export var mcUSDC = buildTokenMapping([
...
export var mcUSDT = buildTokenMapping([
...
export var mcETH = buildTokenMapping([mainnet, optimism, base, arbitrum].map(function (chain) {
    return deployment(chain.id, zeroAddress);
}));
export var mcWETH = buildTokenMapping([
...
//# sourceMappingURL=common-tokens.constants.js.map